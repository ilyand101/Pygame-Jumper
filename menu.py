...
class Menu:
    def _init_(self, punkts = [120, 140, u'Punkt', (250,250,30), (250,30,250)]):#INIT must be with two Underscore symbols, but #youtube don't give create two underscore symbols
        self.punkts = punkts
...
''' описание героя '''
hero = Sprite(350, 350, 'stand1.png')
''' описание цели '''
zet = Sprite(10, 10, 'fall.png')
zet.right = False
zet.step = 1
''' описываем стрелу '''
strela = Sprite(-10, 350, 'jump.png')
strela.push = False
...
while done:
    ...
    hero.render()
    ''' отрисовка шрифтов '''
    info_string.blit(inf_font.render(u'Счёт: '+str(enumerator), 1, (0, 250, 200)), (10, 0))
    info_string.blit(label_font.render(u'ARROW', 1, (0, arrow_color, 0)), (120, 5))
